...
const Testimonials = () => {
  return (
    <div className="bg-[#1E1A25] py-8 flex flex-col items-center gap-12">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 lg:grid-rows-2 md:grid-rows-3 gap-8 content-center items-center mx-6 md:mx-28">
        <div className="row-span-2 flex flex-col items-center gap-8 px-8 py-20 bg-[#22212A] rounded-3xl">
          <div className="flex flex-col items-center gap-4 text-center ">
            ...
            <p className="text-xl text-[#C2C7DC]">
              We pride ourselves on delivering exceptional and tangible results
              that matter to you.
            </p>
          </div>
          {/************************************** */}
        ...
        <div className="bg-[#22212A] px-8 py-12 flex flex-col items-center gap-8 h-full rounded-3xl">
          <p className="text-[#C2C7DC] text-xl  text-center">
            Working with Crator was a game-changer. Their creative vision truly
            amplified our {`brand's`} potential.
          </p>
